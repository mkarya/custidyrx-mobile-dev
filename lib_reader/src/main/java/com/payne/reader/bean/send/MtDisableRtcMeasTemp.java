 ...
 * Date 2020/12/18
 */
public class MtDisableRtcMeasTemp implements TempLabel2Info {
    private final byte[] info;

    MtDisableRtcMeasTemp(Builder builder) {
        int pwLen = builder.passwords.length;
        int measLen = builder.authPwd.length;
        this.info = new byte[pwLen + measLen + 1];
        this.info[0] = TempLabel2Flag.DISABLE_RTC_MEAS_TEMP;
    ...
    public static class Builder {
        ...
        /**
         * Create the {@link MtDisableRtcMeasTemp} instance using the configured values.
         *
         * @return instance
         */
        public MtDisableRtcMeasTemp build() {
            if (passwords == null) {
            ...
            return new MtDisableRtcMeasTemp(this);
        }
    }
}
